...
public class GetWorkLoad {
     ...
     * @return float
     */
    public static float getQualityEngineerWorkLoad(int projectType, int projectLevel, int projectRacking, int projectMemberNumbers) {
     ...
     * @return float
     */
    public static float getGraduateConstructionWorkload(int isTalentTrainingProgram, int NumberOfCurriculumSyllabus, int NumberOfExperimentalSyllabus) {
        float workLoad = 0.0f;
